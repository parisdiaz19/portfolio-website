...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      py-1 sm:top-[1.7rem] sm:h-[initial] sm:py-0"
      >
        <ul
        ...
        >
          {links.map((link, i) => (
            ...
            >
              <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 dark:text-white hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300 ",
                  {
